...
import SharedResourcesWindow from "@/__global-views/shared-resources-window/SharedResourcesWindow.vue";
import {allPlanets, currentPlanet, isPlanetChoserOpen, isPlanetWindowOpen} from "@/__global/PlanetView";
import PlanetWindow from "@/__global-views/planet-window/PlanetWindow.vue";
