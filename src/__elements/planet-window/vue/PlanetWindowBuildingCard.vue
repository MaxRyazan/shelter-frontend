<template>
<div :class="{'building-exist' : planetBuilding}" class="pwb-card">
    <pwb-card-top :building="building" />
    <s-divider />
    <pwb-card-bottom :building="building" />
</div>
</template>
...
.building-exist {
    border: 1px solid var(--prime-light) !important;
}
</style>